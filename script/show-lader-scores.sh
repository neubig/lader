#/bin/bash
echo "============ DEV ja-en =============="
grep "loss [0-9]*\/[0-9][0-9][0-9][0-9][0-9]" test/*/ja-en*.deveval stirlab/*/ja-en*.stirdeveval | sed 's/(loss[^)]*)//g'
echo "============ DEV en-ja =============="
grep "loss [0-9]*\/[0-9][0-9][0-9][0-9][0-9]" test/*/en-ja*.deveval stirlab/*/en-ja*.stirdeveval | sed 's/(loss[^)]*)//g'
echo "============ TEST ja-en =============="
